...
public class RobotMap {
    ...
    public static void init() {
        ...
        try { 
            driveTrainLFrontJag = new CANJaguar(2);
        ...
        try { 
            driveTrainRFrontJag = new CANJaguar(3);
        } catch (CANTimeoutException ex) {
            ex.printStackTrace();
        }
        ...
        try { 
            driveTrainLMidJag = new CANJaguar(4);
        } catch (CANTimeoutException ex) {
            ex.printStackTrace();
        }
        ...
        try { 
            driveTrainRMidJag = new CANJaguar(5);
        } catch (CANTimeoutException ex) {
            ex.printStackTrace();
        }
        ...
        try { 
            driveTrainLBackJag = new CANJaguar(6);
        } catch (CANTimeoutException ex) {
            ex.printStackTrace();
        }
        ...
        try { 
            driveTrainRBackJag = new CANJaguar(7);
        } catch (CANTimeoutException ex) {
            ex.printStackTrace();
        }
